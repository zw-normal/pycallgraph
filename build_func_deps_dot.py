...
if __name__ == '__main__':
    ...
    if len(func_defs[func_to_check]) > 5:
        print('More than 5 different definitions for function {}. Please pick another one.'.format(func_to_check))
    else:
        for func in func_defs[func_to_check]:
            try:
                ...
                print('The function "{}" is not found.'.format(func))
