...
from build_func_deps_config import (
    func_to_check, funcs_to_exclude, upstream_cutoffs, downstream_cutoff, output_folder)
...
output_dot_file = os.path.join(output_folder, '{}.dot'.format(func_to_check))
output_png_file = os.path.join(output_folder, '{}.png'.format(func_to_check))
